...
User.updateMany({ age: { $gt: 40 } }, { age: 50 }).then((res) =>
  console.log(res),
);
User.findOneAndUpdate({ name: "Jack" }, { age: 55 }, { new: true }).then(
  (res) => console.log(res),
);
User.findByIdAndUpdate(
  "66bb8ec7e104af275d8283d2",
  { age: 60 },
  { new: true },
).then((res) => console.log(res));
```
...
User.findByIdAndDelete("66bb8d0d0e196aa24309c16f").then((res) =>
  console.log(res),
);
